...
<div class="row offset-lg-1 offset-sm-3 ofset-md-2 offset-3" style="margin-top:5px">
    <form action="/searchphadmin" class="form-inline my-2 my-lg-0" method="get">
        @csrf
...
<div class="row offset-lg-1 offset-sm-3 ofset-md-2 offset-3">
    ...
    <tr>
        ...
        <td><a href="/detailsphadmincomplaint/{{$i->id}}" class="btn btn-warning">Action</a></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/deletephcomplaint/{{$i->id}}" class="btn btn-danger">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
