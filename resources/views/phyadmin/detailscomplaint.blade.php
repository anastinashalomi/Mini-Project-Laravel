...
<div>
<a href="/updatestatusphadmin/{{$complaintdata->id}}" class="btn btn-warning">TakeAction</a> &nbsp &nbsp &nbsp
 <a href="/physicsadmincomplaint" class="btn btn-warning">Cancel</a>
</div>
