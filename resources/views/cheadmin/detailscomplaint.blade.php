...
<div>
<a href="/updatestatuschadmin/{{$complaintdata->id}}" class="btn btn-warning">TakeAction</a> &nbsp &nbsp &nbsp
 <a href="/chemistryadmincomplaint" class="btn btn-warning">Cancel</a>
</div>
