...
<div class="row  offset-lg-1 offset-sm-3 ofset-md-2 offset-3">
    ...
    <div class="">
    <div class="container"><h3><a href="/computercomplaint">Computer Laboratory</a></h3></div>
        <div class="card-deck">
                ...
                <div class="card card3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-sm-6 col-md-6 text-right">
                                <h3><b>&nbsp{{$countnu['totalnot'] }}</b></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-sm-6 col-md-6 text-right">
                                <h3><b>&nbsp&nbsp{{$countnu['totalpro'] }}</b></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card2">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-sm-6 col-md-6 text-right">
                                <h3><b>&nbsp&nbsp{{$countnu['totalcom'] }}</b></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row  offset-lg-1 offset-sm-3 ofset-md-2 offset-3">
    ...
    <div class="">
    <div class="container"><a href="/physicscomplaint"><h3>Physics Laboratory</h3></a></div>
        <div class="card-deck">
                ...
                <div class="card card3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-sm-6 col-md-6 text-right">
                                <h3><b>&nbsp&nbsp{{$countnu['totalnotp'] }}</b></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-sm-6 col-md-6 text-right">
                                <h3><b>&nbsp&nbsp{{$countnu['totalprop'] }}</b></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card2">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-sm-6 col-md-6 text-right">
                                <h3><b>&nbsp&nbsp{{$countnu['totalcomp'] }}</b></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row  offset-lg-1 offset-sm-3 ofset-md-2 offset-3">
    ...
    <div class="">
    <div class="container"><a href="/chemistryscomplaint"><h3>Chemistry Laboratory</h3></a></div>
        <div class="card-deck">
                ...
                <div class="card card3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-6 col-sm-6 col-md-6 text-right">
                                <h3><b>&nbsp&nbsp{{$countnu['totalnotc'] }}</b></h3>
                            </div>
                        </div>
                    </div>
                </div>
