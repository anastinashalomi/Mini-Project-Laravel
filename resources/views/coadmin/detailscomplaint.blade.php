...
<div>
<a href="/updatestatuscadmin/{{$complaintdata->id}}" class="btn btn-warning">TakeAction</a> &nbsp &nbsp &nbsp
 <a href="/computeradmincomplaint" class="btn btn-warning">Cancel</a>
</div>
