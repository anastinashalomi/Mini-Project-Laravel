...
<div>
<a href="/updatechemistrystatus/{{$complaintdata->id}}" class="btn btn-warning">TakeAction</a>&nbsp &nbsp &nbsp
 <a href="/chemistryscomplaint" class="btn btn-warning">Cancel</a>
</div>
