...
<form action="/searchche" class="form-inline my-2 my-lg-0" method="get">
@csrf
<input type="search" class="form-control mr-sm-2" name="query" type="search" placeholder="SearchByName">
...
<h4 class="">Complaints of Chemistry Laboratory</h4>
</div>
...
<td><a href="/detailschemistrycomplaint/{{$i->id}}" class="btn btn-warning">Action</a></td>
<!--<td><a href="/deletecomplaintc/{{$i->id}}" class="btn btn-warning">Delete</a></td>-->
<td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/deletecomplaintc/{{$i->id}}" class="btn btn-danger">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
